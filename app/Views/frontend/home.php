...
<main>
  <!-- Affichage de mes bière stockées en base de données -->
  <section id="bieres" class="bieres">
    ...
    <article id="<?= $beer['idname'] ?>" class="presentationbiere <?= $beer['idname'] ?>">
      ...
      <img src="<?= $beer['img'] ?>" alt="bière <?= strtolower($beer['name']) ?>" class="verrebiere">
  ...
  <!-- Appel d'un affichage type réseaux sociaux -->
  <?php require_once 'layouts/socials.php'; ?>
  <!-- Affichage de l'endroit où me trouver -->
