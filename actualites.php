<?php require_once './layouts/head.php'; ?>
	<main class="container">
		<article id="articles">
				...
				<h5>Etape 1</h5>
				<p>Acheter 1 produit de la gamme BEEAR parmi les références suivantes : <a href="index.html#bblonde" class="linkactus">BEEAR BLONDE</a>,<a href="index.html#bbrune" class="linkactus"> BEEAR BRUNE</a>,<a href="index.html#bblanche" class="linkactus"> BEEAR BLANCHE</a> en 3×33 cl ou 75 cl dans un magasin participant à l’opération.</p>
				<p>Vous pouvez également retrouver <a href="valeurs.html" class="linkactus">LES VALEURS DE L'ENTREPRISE</a> , ainsi que <a href="index.html#bblonde" class="linkactus">NOS PRODUITS.</a> </p>
				...
				<p>En cas de réclamation, vous pouvez directement nous contacter via notre formulaire sur la page <a href="contact.html" class="linkactus">CONTACT</a>.</p>
		</article>
		...
		<div id="socials">
			...
			<a href="https://facebook.com" class="flex-button"><p class="button">Facebook</p></a>
			<a href="https://instagram.com" class="flex-button"><p class="button">Instagram</p></a>
			<a href="https://twitter.com" class="flex-button"><p class="button">Twitter</p></a>
		</div>
	</main>
